...
//        });
        ...
        UserApiService.getInstance(this).getAdBatch(new BaseObserver<CECAdBatchListBean>(){
            @Override
            public void onResponse(@NonNull BaseResponse<CECAdBatchListBean> baseResponse, @Nullable CECAdBatchListBean data) {

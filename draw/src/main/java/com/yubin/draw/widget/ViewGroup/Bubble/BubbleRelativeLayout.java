...
public class BubbleRelativeLayout extends RelativeLayout {
    ...
    public static int SHADOW_COLOR = Color.parseColor("#3C4048");
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                STROKE_WIDTH = a.getFloat(R.styleable.bubble_strokeWidths, STROKE_WIDTH);
        ...
        mFillPaint.setShader(new LinearGradient(100f, 0f, 100f, 200f, SHADOW_COLOR, SHADOW_COLOR, TileMode.CLAMP));

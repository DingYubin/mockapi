...
public class ImageFolderAdapter extends BaseAdapter {
    ...
    public ImageFolderAdapter(Activity activity, List<ImageFolder> folders, boolean loadVideo) {
        mActivity = activity;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (!loadVideo) {
            ...
            holder.imageCount.setText(mActivity.getString(R.string.ip_folder_video_count, folder.images.size()));
        }

    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setPhotoViewClickListener(new ImagePageAdapter.PhotoViewClickListener() {
            ...
            public void onVideoButtonClicked(ImageItem imageItem) {
                ...
                //播放视频
                Intent intent = new Intent(ImagePreviewBaseActivity.this, ImageVideoPlayActivity.class);
                Bundle data = new Bundle();
                data.putString("video_path", imageItem.path);
                data.putString("video_name", imageItem.name);

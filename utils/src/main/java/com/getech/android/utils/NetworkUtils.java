...
public final class NetworkUtils {
    ...
    private static ArrayList<NetworkStatusChangedListener> networkStatusChangedListeners;
    private static final BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {

        @Override
        public void onReceive(Context context, Intent intent) {
            if (networkStatusChangedListeners != null) {
                for (NetworkStatusChangedListener listener : networkStatusChangedListeners) {
     ...
     *
     * @param activity
     * @param networkStatusChangedListener
     * @return
     */
    public static BroadcastReceiver startMonitorNetworkStatus(Activity activity, final NetworkStatusChangedListener networkStatusChangedListener) {
        BroadcastReceiver networkReceiver = new BroadcastReceiver() {
            @Override
            public void onReceive(Context context, Intent intent) {
                if (networkStatusChangedListener != null) {
                    NetworkType networkType = getNetworkType();
                    networkStatusChangedListener.onNetworkStatusChanged(networkType);
                }
            }
        };
     ...
     * @param receiver
     */
    public static void stopMonitorNetworkStatus(Activity activity, BroadcastReceiver receiver) {
        try {
    ...
    public enum NetworkType {
        ...
        NETWORK_ETHERNET(-2, "ethernet");
        private int code;
        private String message;

        NetworkType(int code, String msg) {
            this.code = code;
            this.message = msg;
        }
    ...
    public interface NetworkStatusChangedListener {
        void onNetworkStatusChanged(NetworkType networkType);
    }
}

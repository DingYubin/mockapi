...
import com.getech.android.utils.constant.Constant;
...
public class MultiLanguageUtils {
    ...
    public static void changeLanguage(Context context, String language, String area) {
        if (TextUtils.isEmpty(language) && TextUtils.isEmpty(area)) {
            //如果语言和地区都是空，那么跟随系统s
            MultiLanguageSPUtils.put(context, Constant.SP_LANGUAGE, "");
            MultiLanguageSPUtils.put(context, Constant.SP_COUNTRY, "");
        } else {
...
//        IntentUtils.toActivity(context,MainActivity.Class,true);
    ...
    private static Context setLanguage(Context context, Locale locale, Configuration configuration) {
    ...
    public static Context attachBaseContext(Context context) {
        String spLanguage = (String) MultiLanguageSPUtils.get(context, Constant.SP_LANGUAGE, "");
        String spCountry = (String) MultiLanguageSPUtils.get(context, Constant.SP_COUNTRY, "");
        Resources resources = context.getResources();
        ...
        Context context1 = setLanguage(context, locale, configuration);
    ...
    public static boolean isSameWithSetting(Context context) {
        ...
        String sp_language = (String) MultiLanguageSPUtils.get(context, Constant.SP_LANGUAGE, "");
        String sp_country = (String) MultiLanguageSPUtils.get(context, Constant.SP_COUNTRY, "");
    ...
    public static void saveLanguageSetting(Context context, Locale locale) {
        MultiLanguageSPUtils.put(context, Constant.SP_LANGUAGE, locale.getLanguage());
        MultiLanguageSPUtils.put(context, Constant.SP_COUNTRY, locale.getCountry());
    }
    ...
    public static boolean isEn(Context mContext) {
        String language = (String) MultiLanguageSPUtils.get(mContext, Constant.SP_LANGUAGE, "");
    ...
    public static Application.ActivityLifecycleCallbacks callbacks = new Application.ActivityLifecycleCallbacks() {
        ...
        public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
            String language = (String) MultiLanguageSPUtils.get(activity, Constant.SP_LANGUAGE, "");
            String country = (String) MultiLanguageSPUtils.get(activity, Constant.SP_COUNTRY, "");
